...
namespace MonoTouch.Dialog
{
	public class MultilineEntryElementCell: UITableViewCell {
		...
		public void Update(MultilineEntryElement element, UITableView tableView){
			...
			TextLabel.Text = element.Caption;Console.WriteLine("MEEC - Update");
		}
		...
		protected virtual void PrepareEntry(UITableView tableview){
            ...
            var bottomspace = 40;
			_entry = new UITextView(new RectangleF(leftspace,TextLabel.Frame.Bottom,Frame.Width-rightspace, Frame.Height-bottomspace));
                _entry.ContentOffset = PointF.Empty;
            ...
            _entry.Scrolled += delegate(object sender, EventArgs e) {
                _entry.ContentOffset = PointF.Empty;
             };

            _entry.ScrollAnimationEnded += delegate(object sender, EventArgs e) {
                _entry.ContentOffset = PointF.Empty;
             };
			...
			_entry.Changed += delegate {
				...
				_entry.Frame = new RectangleF(leftspace,TextLabel.Frame.Bottom,Frame.Width-rightspace, Frame.Height-bottomspace);
                _entry.ContentOffset = PointF.Empty;
